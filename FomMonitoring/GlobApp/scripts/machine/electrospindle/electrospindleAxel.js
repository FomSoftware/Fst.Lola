var ElectroSpindleAxel = function () {
    var vmElectroSpindle;

    var init = function (data) {
        initVueModel(data.vm_electro_spindle_axel);
    }
            ...
            methods: {
                noData: function() {
                    if (this.values == null || (
                        ...
                        this.values.RpmRange24000 == null)) {
                        return true;
                    } else {
                        return false;
                    }
    ...
    var update = function (data) {
        ...
        var vm_electro_spindle = data.vm_electro_spindle_axel;
